            ...
            <React.Fragment>
                ...
                <div className="whyChoosePerflowSection">
                    <div className="TitleDiv text-center" >
                        <h1 className="Title" id="title1">Why Choose Perflow?</h1>
                ...
                <div className="testimonialsSection">
                    <div className="TitleDiv text-center">
                        <h1 className="Title" id="title2">Testimonials</h1>
                    </div>
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-lg-4 mt-lg-4 mr-lg-1 mb-lg-5 ml-lg-auto
                                            col-md-6 ml-md-auto mt-md-3 mr-md-auto mb-md-3
                                            col-sm-6 mr-sm-6" id="card1column">
                                
                                <div className="card" id="card1">
                                    <div className="card-body" id="cardup1">
                                    </div>
                                    <div className="card-body" id="cardbody1">
                                        <img className="avatar rounded-circle" alt="per1" src="person1.png" id="cardimage1"/>
                            ...
                            <div className="col-lg-4 mt-lg-4 mr-lg-auto mb-lg-5 ml-lg-1
                                            col-md-6 ml-md-auto mt-md-3 mr-md-auto mb-md-3
                                            col-sm-6 mr-sm-6" id="card2column">
                                ...
                                <div className="card" id="card2">
                                    ...
                                    <div className="card-body"id="cardbody2">
                                        <img className="avatar rounded-circle" alt="per1" src="person2.png" id="cardimage2"/>
