                ...
                <div className="card">
                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-xs-12 col-md-4">
                            <div className="card mt-5 mr-5 ml-5">
                                ...
                                <div className="card-body text-center">
                                    <h5 className="card-title">Milad</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col-xs-12 col-md-4">
                            <div className="card mt-5 mr-5 ml-5">
                                ...
                                <div className="card-body text-center">
                                    <h5 className="card-title">Tarek</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                        <div className="col-xs-12 col-md-4">
                            <div className="card mt-5 mr-5 ml-5">
                                ...
                                <div className="card-body text-center">
                                    <h5 className="card-title">Melany</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col-xs-12 col-md-4">
                            <div className="card mt-5 mr-5 ml-5">
                                ...
                                <div className="card-body text-center">
                                    <h5 className="card-title">Pratima</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col-xs-12 col-md-4">
                            <div className="card mt-5 mr-5 ml-5">
                                ...
                                <div className="card-body text-center">
                                    <h5 className="card-title">Sidhi</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                        <div className="col-xs-12 col-md-4">
                            <div className="card mt-5 mr-5 ml-5">
                                <div className="card-body text-center">
                                    <img className="rounded-circle" src="./aboutUs-Asmaa.jpg" alt="..." />
                                </div>
                                <div className="card-body text-center">
                                    <h5 className="card-title">Asmaa</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col-xs-12 col-md-4">
